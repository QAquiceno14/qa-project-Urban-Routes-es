...
class UrbanRoutesPage:
    ...
    def click_fare_comfort(self):
        WebDriverWait(self.driver, 20).until(expected_conditions.element_to_be_clickable(localizadores.LUrbanRoutesPage.fare_comfort))
    ...
    def set_confirmation_code(self, code):
        WebDriverWait(self.driver, 20).until(expected_conditions.visibility_of_element_located(localizadores.LUrbanRoutesPage.enter_code_field))
